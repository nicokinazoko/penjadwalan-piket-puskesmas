                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="{{ route('view-data-algoritma-genetika') }}">
                                    Algoritma Genetika</a>
                            </li>
                            <li class="breadcrumb-item active"><a
                                    href="{{ route('view-data-penjadwalan-algoritma-genetika', ['tanggal_pembuatan' => $dataPenjadwalan[0]->tanggal_pembuatan_jadwal]) }}">Lihat
                                    Data Algoritma Genetika</a>
                            </li>
            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Data Penjadwalan Algoritma Genetika</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form
                        action="{{ route('edit-data-penjadwalan-algoritma-neuro-fuzzy-proses', ['id_penjadwalan_genetika' => $dataPenjadwalan[0]->id_penjadwalan_genetikas]) }}"
                        method="POST">
                        @method('PATCH')
                        @csrf
                        <div class="card-body">
                            <input type="hidden" class="form-control" id="inputNamaPegawai" placeholder="Nama Pegawai"
                                name="inputIdPenjadwalan" value="{{ $dataPenjadwalan[0]->id_penjadwalan_genetikas }}"
                                readonly>
