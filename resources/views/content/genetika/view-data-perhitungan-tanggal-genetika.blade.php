...
@section('title', 'SPP | Hasil Algoritma Genetika')
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex p-0">
                        ...
                        <ul class="nav nav-pills ml-auto p-2">
                            <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Hasil
                                    Penjadwalan</a>
                            </li>
    ...
    <script>
        $(function() {
            ...
            var donutData = {
                ...
                datasets: [{
                    data: [
                        {{ $dataPerhitunganGenetika[0]->nilai_fitness_tiga }},
                        {{ $dataPerhitunganGenetika[0]->nilai_fitness_dua }},
                        {{ $dataPerhitunganGenetika[0]->nilai_fitness_satu }},
                        {{ $dataPerhitunganGenetika[0]->nilai_fitness_nol }},
                        {{ $dataPerhitunganGenetika[0]->nilai_fitness_min_satu }},
                        {{ $dataPerhitunganGenetika[0]->nilai_fitness_kosong }}
