    ...
    <script>
        $(function() {
            ...
            var donutData = {
                ...
                datasets: [{
                    data: [
                        {{ $dataPerhitunganMemetika[0]->nilai_fitness_tiga }},
                        {{ $dataPerhitunganMemetika[0]->nilai_fitness_dua }},
                        {{ $dataPerhitunganMemetika[0]->nilai_fitness_satu }},
                        {{ $dataPerhitunganMemetika[0]->nilai_fitness_nol }},
                        {{ $dataPerhitunganMemetika[0]->nilai_fitness_min_satu }},
                        {{ $dataPerhitunganMemetika[0]->nilai_fitness_kosong }}
