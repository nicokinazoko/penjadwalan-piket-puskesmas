...
class CreateHasilPerhitunganMemetikasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('hasil_perhitungan_memetikas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('hasil_perhitungan_memetikas');
    }
}
